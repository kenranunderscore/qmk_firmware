...
#define D_QWERTY DF(QWERTY)
#define ERESET EEPROM_RESET
...
// left              ┌────────┬────────┬────────┬────────┬────────┬────────┐
#define QWERTY_TOP_L  NAV_TAB, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T
#define QWERTY_MID_L  MC(BSPC),KC_A,    KC_S,    KC_D,    KC_F,    KC_G
#define QWERTY_BOT_L  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B

// right             ┌────────┬────────┬────────┬────────┬────────┬────────┐
#define QWERTY_TOP_R  KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    MG(MINS)
#define QWERTY_MID_R  KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, MC(QUOT)
#define QWERTY_BOT_R  KC_N,    KC_M,    KC_DOT,  KC_COMM, KC_SLSH, KC_RSFT
...
// left              ┌────────┬────────┬────────┬────────┬────────┬────────┐
#define NUM_TOP_L     D_MTGAP, KC_1,    KC_2,    KC_3,    KC_4,    KC_5
#define NUM_MID_L     D_QWERTY,_______, _______, _______, _______, _______
...
#define NAV_MID_L     _______, D_QWERTY,D_MTGAP, _______, _______, KC_VOLD
